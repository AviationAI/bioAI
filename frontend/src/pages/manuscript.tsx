        ...
        {(manuscript !== null) ? (
            ...
            <div className = "min-h-screen flex flex-row justify-start gap-7 -m-[25px] bg-[#f4f4f4]">
                ...
                <main className = "flex flex-col flex-1 m-1 py-[25px] pr-[25px]">
                    ...
                    {page > 0 &&
                        <ManuscriptSectionSection key = {manuscript?.sections?.[page - 1].id} section = {manuscript?.sections?.[page - 1] as ManuscriptSection} createSection = {create_section} increment = {increment} decrement = {decrement} isLast = {page === manuscript?.sections?.length} creating = {creatingSection} newTitle = {title} setNewTitle = {setTitle} manuscriptDependency = {dependency} setManuscriptDependency = {setDependency}/>
                    } 
                </main>
            </div>
            </>
