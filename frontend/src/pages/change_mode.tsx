            ...
            <main className = "flex flex-1">
                {project !== null &&
                    <>
                        ...
                        {page === 3 && <GenerateSources increment = {incrementPage} decrement = {decrementPage} topic = {topic} rq = {rq} sources = {sources} setSources = {setSources} generated = {sourcesgen} setGenerated = {setSourcesgen}/>}
