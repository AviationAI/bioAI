...
function Summary({setCount, topic, rq, increment, decrement, summary, description, generated, setGenerated}: {setCount: any, topic: any, rq: any, increment: any, decrement: any, summary: any, description: any, generated: any, setGenerated: any}) {
    ...
    async function generate() {
        if (!generated) {
            try {
                ...
                const response = await AxiosInstance.post(`/api/generate/summary`, {
                    "topic": topic,
    ...
    return (
        <div className = "flex flex-col">
            <h3 className = "font-bold text-3xl">Summary</h3>
            <p className = "font-light text-sm">After selecting a topic and research question, you can automatically generate a summary of the topic and research question. This summary may not be accurate and will be less comprehensive than the summary of literature.</p>
            <div className = "border-2 m-3 p-3 rounded-md flex w-fit flex-row flex-wrap">
                <div className = "mr-3 flex flex-col">
                    ...
                    <p className = "font-extralight text-sm max-w-prose">Automatically generate summary based on topic and research question. The summary is NOT based on available literature.</p>
                    <button onClick = {generate} disabled = {generated || generating} className = "text-[#f4f4f4] bg-red-700 w-fit m-5 hover:bg-red-900 disabled:bg-amber-950">✨ Generate Summary</button>
